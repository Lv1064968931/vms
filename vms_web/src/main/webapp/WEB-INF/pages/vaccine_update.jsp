    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form action="/vaccine/update" modelAttribute="vaccine"  id="admin-form" name="addForm">
                    <form:hidden path="id"/>
                    ...
                    <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="name" class="field prepend-icon">
                                    <form:input path="productionDate" class="gui-input" placeholder="生产日期..."/>
                                    <label for="name" class="field-icon">
                                        <i class="fa fa-user"></i>
                                    </label>
                                </label>
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="name" class="field prepend-icon">
                                    <form:input path="expirationDate" class="gui-input" placeholder="过期时间..."/>
                                    <label for="name" class="field-icon">
                                        <i class="fa fa-user"></i>
                                    </label>
                                </label>
